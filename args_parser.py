...
def global_parser():
    ...
    parser.add_argument('--source_domains_list', type=list,  default=['raw_rgb', 'sobel_0_3', 'laplace_0_3'])
    parser.add_argument('--feature_backbone', default='i3d', type=str, help='i3d, r2p1d, x3d, vit')
    parser.add_argument('--source', default='cmd', type=str)
    ...
    parser.add_argument('--launch_mode', type=str, default="train", help="train, infer", choices=['train', 'infer'])
    parser.add_argument('--modality', type=str, default="visible", help="The input of the model", choices=['visible', 'edge', 'tir'])
    parser.add_argument('--continue_training', type=boolean_string, default=True)

    #data setting
    parser.add_argument('--affine_transform', type=boolean_string, default=True)
    parser.add_argument('--cuda', type=boolean_string, default=True)

    parser.add_argument('--input', type=str, default='video', choices=['video', 'idt'])
