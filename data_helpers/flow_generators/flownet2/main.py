...
import flownet2.models as models, flownet2.losses as losses, flownet2.datasets as datasets
...
if __name__ == '__main__':
    ...
    with tools.TimerBlock("Parsing Arguments") as block:
        ...
        print(args.inference_dataset_class)
    ...
    with tools.TimerBlock("Initializing Datasets") as block:
        ...
        print('mlmlppplmlmlmmmlp')
        print(exists(args.inference_dataset_root))
